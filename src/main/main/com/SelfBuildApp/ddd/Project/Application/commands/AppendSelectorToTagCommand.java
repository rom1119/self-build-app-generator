...
@Command
public class AppendSelectorToTagCommand implements Serializable {

    private AggregateId parentTagId;
    private PseudoSelector pseudoSelector;

    public AppendSelectorToTagCommand(AggregateId parentTagId, PseudoSelector pseudoSelector) {
